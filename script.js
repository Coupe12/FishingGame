...
class Player {
    ...
    draw(){
        ...
        if(this.x >= mouse.x){
            ...
            this.spriteHeight, this.spriteWidth, this.spriteHeight, 0 - 50, 0 - 55, 
...
bubbleImage.src = 'image/bubble_pop.png';
...
class Bubble {
    ...
    draw(){
        ...
        // ctx.closePath();
        // ctx.stroke();
        ctx.drawImage(bubbleImage, this.x - 60, this.y - 83, this.radius * 2.2, this.radius * 2.7)
    }
}
...
bubblePop2.src = 'sound/bubbles-single1.wav';
...
function handleGameOver(){
    ctx.fillStyle= 'white';
    ctx.fillText('Game Over, You reached a score of '+ score, 70, 250);
    gameOver = true;
}
